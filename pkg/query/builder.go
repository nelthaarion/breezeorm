...
func (b Builder[T]) clone() Builder[T] {
	// Slices are copied shallow-but-safe: builder methods always append to a
	// freshly allocated slice below rather than mutating b's backing array.
	return b
}
...
func (b Builder[T]) Select(exprs ...SelectExpr) Builder[T] {
	n := b.clone()
	n.selects = append(append([]SelectExpr{}, b.selects...), exprs...)
	return n
}
...
func (b Builder[T]) Join(j Join) Builder[T] {
	n := b.clone()
	n.joins = append(append([]Join{}, b.joins...), j)
	return n
}
...
func (b Builder[T]) GroupBy(cols ...string) Builder[T] {
	n := b.clone()
	n.groupBy = append(append([]string{}, b.groupBy...), cols...)
	return n
}
...
func (b Builder[T]) OrderBy(terms ...OrderTerm) Builder[T] {
	n := b.clone()
	n.orderBy = append(append([]OrderTerm{}, b.orderBy...), terms...)
	return n
}
...
func (b Builder[T]) With(cte CTE) Builder[T] {
	n := b.clone()
	n.ctes = append(append([]CTE{}, b.ctes...), cte)
	return n
}

func (b Builder[T]) Union(other Builder[T]) Builder[T] {
	n := b.clone()
	n.unions = append(append([]unionClause{}, b.unions...), unionClause{all: false, other: other})
	return n
}

func (b Builder[T]) UnionAll(other Builder[T]) Builder[T] {
	n := b.clone()
	n.unions = append(append([]unionClause{}, b.unions...), unionClause{all: true, other: other})
	return n
}
...
func (b Builder[T]) Preload(path string, opts ...func(*PreloadSpec)) Builder[T] {
	...
	n := b.clone()
	n.preloads = append(append([]PreloadSpec{}, b.preloads...), spec)
	return n
}
